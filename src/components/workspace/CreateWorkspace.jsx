...
export default function CreateWorkspace({ onWorkspaceAdded }) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-full sm:w-2/3 md:w-1/2 lg:w-1/3 !max-w-full rounded-l-2xl p-10 md:p-10 bg-gray-50 border-l shadow-xl">
        <SheetHeader className="mb-1 -ml-4 md:-ml-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 -mt-3">
          <div>
            ...
            <TextInput
              ...
              autoFocus
              className={`mt-1 w-full border border-gray-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 ${errors.name ? 'focus:ring-red-500' : 'focus:ring-blue-300'}`}
            />
