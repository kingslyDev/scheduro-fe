  ...
  return (
    <section id="feature" className="py-24 px-4">
      <div className="max-w-screen-lg mx-auto text-center -mt-12">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-4 tracking-wider">
        ...
        <p className="text-l text-gray-700 mt-4 max-w-2xl mx-auto tracking-wider">
          ...
          <span className="text-l block text-center text-gray-700 mt-2">
            effortlessly!
          </span>
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 mt-14 px-5">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#CCDAF1] p-6 rounded-lg shadow-md text-left transition hover:scale-105 flex flex-col items-start"
            >
              <img
                src={feature.icon}
                alt={feature.title}
